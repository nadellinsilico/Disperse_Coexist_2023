...
df = pd.read_excel('SI_Data.xlsx', sheet_name='Fig3C_1')
df_wt =  pd.read_excel('SI_Data.xlsx', sheet_name='Fig3C_0') 
...
Figure 3D
"""
df = pd.read_excel('SI_Data.xlsx', sheet_name='Fig3D').T.reset_index()
...
Figure 4E
"""
df = pd.read_excel('SI_Data.xlsx', sheet_name='Fig4E')
...
Figure 4F
"""
df = pd.read_excel('SI_Data.xlsx', sheet_name='Fig4F')
my_pal = {'WT_Pre':'black', 'WT_Post':'black', 'bqsS_Pre':'green', 'bqsS_Post':'green'}
...
SI Figure S2B is taken from Fig1C
"""
...
# plt.savefig('FigS2A.svg', dpi=300, facecolor='w', edgecolor='b',
#         orientation='portrait', format='svg',
#         transparent=False, bbox_inches='tight', pad_inches=.05, metadata=None)
plt.show()
...
df_og = pd.read_excel('SI_Data.xlsx', sheet_name='FigS4A_1')
df = df_og.groupby('time').mean().reset_index()
...
plt.xlabel('Time (d)')
plt.title('Biofilm Culture')
# plt.savefig('FigS4A_1.svg', dpi=300, facecolor='w', edgecolor='b',
#         orientation='portrait', format='svg',
#         transparent=False, bbox_inches='tight', pad_inches=.05, metadata=None)
plt.show()

df_og = pd.read_excel('SI_Data.xlsx', sheet_name='FigS4A_2')
df = df_og.groupby('time').mean().reset_index()
...
plt.xlabel('Time (d)')
plt.title('Biofilm Culture')
# plt.savefig('FigS4A_2.svg', dpi=300, facecolor='w', edgecolor='b',
#         orientation='portrait', format='svg',
#         transparent=False, bbox_inches='tight', pad_inches=.05, metadata=None)
plt.show()

df_og = pd.read_excel('SI_Data.xlsx', sheet_name='FigS4A_3')
df = df_og.groupby('time').mean().reset_index()
...
plt.xlabel('Time (d)')
plt.title('Biofilm Culture')
# plt.savefig('FigS4A_3.svg', dpi=300, facecolor='w', edgecolor='b',
#         orientation='portrait', format='svg',
#         transparent=False, bbox_inches='tight', pad_inches=.05, metadata=None)
plt.show()
...
df_og = pd.read_excel('SI_Data.xlsx', sheet_name='FigS4B_1')
df = df_og.groupby('time').mean().reset_index()
...
plt.xlabel('Time (d)')
plt.title('Biofilm Culture')
# plt.savefig('FigS4B_1.svg', dpi=300, facecolor='w', edgecolor='b',
#         orientation='portrait', format='svg',
#         transparent=False, bbox_inches='tight', pad_inches=.05, metadata=None)
plt.show()

df_og = pd.read_excel('SI_Data.xlsx', sheet_name='FigS4B_2')
df = df_og.groupby('time').mean().reset_index()
...
df_og = pd.read_excel('SI_Data.xlsx', sheet_name='FigS4B_3')
df = df_og.groupby('time').mean().reset_index()
...
df = pd.read_excel('SI_Data.xlsx', sheet_name='FigS8B')
...
# plt.savefig('FigS8B.svg', dpi=300, facecolor='w', edgecolor='b',
#         orientation='portrait', format='svg',
#         transparent=False, bbox_inches='tight', pad_inches=.05, metadata=None)
plt.show()
...
df = pd.read_excel('SI_Data.xlsx', sheet_name='FigS9A')
...
SI Figure S9C
"""
Pa = pd.read_excel('SI_Data.xlsx', sheet_name='FigS9C_1')
Ec = pd.read_excel('SI_Data.xlsx', sheet_name='FigS9C_2')
Ef = pd.read_excel('SI_Data.xlsx', sheet_name='FigS9C_3')
...
spatial_data = scipy.io.loadmat('Reaction_Diff_Model/spatial_data_SI_Fig_null.mat')
...
plt.plot(df['t'], df['ch1'], color='#E2E604')
plt.plot(df['t'], df['ch2'], color='#008F8F')
plt.plot(df['t'], df['ch3'], color='purple')
plt.grid(False)
...
spatial_data = scipy.io.loadmat('Reaction_Diff_Model/spatial_data_SI_Fig_unbiased.mat')
data = {'ch1':spatial_data['ch1'].flatten(), 'ch2':spatial_data['ch2'].flatten(), 'ch3':spatial_data['ch3'].flatten(), 't':spatial_data['t'].flatten()}
df = pd.DataFrame(data, columns=list(data.keys()))
...
PDE Model Biased Dispersal
"""

spatial_data = scipy.io.loadmat('Reaction_Diff_Model/spatial_data_SI_Fig_biased.mat')
data = {'ch1':spatial_data['ch1'].flatten(), 'ch2':spatial_data['ch2'].flatten(), 'ch3':spatial_data['ch3'].flatten(), 't':spatial_data['t'].flatten()}
df = pd.DataFrame(data, columns=list(data.keys()))
...
df = pd.read_csv('Stochastic_Spatial_Model/mixed_biased_dispersal.csv')
